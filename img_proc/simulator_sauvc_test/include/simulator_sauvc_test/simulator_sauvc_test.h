...
private:
  ...
  ros::Publisher gate_detect_status_pub, yellow_flare_detect_status_pub, red_flare_detect_status_pub, bucket_detect_status_pub;

  ros::ServiceServer conf_service_red, conf_service_yellow, conf_service_gate, conf_service_bucket ;

  cv::Mat front_image, bottom_image;

  bool ip_status_front, ip_status_bottom, status_gate, status_bucket,
      status_flare,status_yellow_flare, has_image_received;
  bool detection_status_gate, detection_status_bucket, detection_status_red_flare, detection_status_yellow_flare;
  std_msgs::UInt8 enabled, disabled;
...
// added ------
  ...
  bool getYellowFlareCoordinates(simulator_sauvc_test::Coordinates::Request &req,
                           simulator_sauvc_test::Coordinates::Response &res);
  void imageProcessingYellowFlare();
// end --------
};
